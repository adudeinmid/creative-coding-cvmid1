class Wing {
    ...
    if(Math.abs(this.targetwingPos - this.wingPos)>0.01)this.wingPosition();
    else this.wingPos = this.targetwingPos;
    ...
    wingPosition(y){
      ...
      this.wingPos = Math.abs(this.originwingPos + (this.targetwingPos - this.originwingPos) * ease);
    }
